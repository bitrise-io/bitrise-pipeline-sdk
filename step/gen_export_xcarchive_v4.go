...
func (b *ExportXcarchiveV4Builder) WithVersion(version string) *ExportXcarchiveV4Builder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *ExportXcarchiveV4Builder) WithInput(key, value string) *ExportXcarchiveV4Builder {
