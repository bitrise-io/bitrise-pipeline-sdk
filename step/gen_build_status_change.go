...
func (b *BuildStatusChangeBuilder) WithVersion(version string) *BuildStatusChangeBuilder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *BuildStatusChangeBuilder) WithInput(key, value string) *BuildStatusChangeBuilder {
