...
func (b *CreateGithubPullRequestBuilder) WithVersion(version string) *CreateGithubPullRequestBuilder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *CreateGithubPullRequestBuilder) WithInput(key, value string) *CreateGithubPullRequestBuilder {
