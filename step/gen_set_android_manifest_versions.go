...
func (b *SetAndroidManifestVersionsBuilder) WithVersion(version string) *SetAndroidManifestVersionsBuilder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *SetAndroidManifestVersionsBuilder) WithInput(key, value string) *SetAndroidManifestVersionsBuilder {
