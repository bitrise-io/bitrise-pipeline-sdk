...
func (b *FortifyOnDemandMobileAssessmentBuilder) WithVersion(version string) *FortifyOnDemandMobileAssessmentBuilder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *FortifyOnDemandMobileAssessmentBuilder) WithInput(key, value string) *FortifyOnDemandMobileAssessmentBuilder {
