...
func (b *CordovaArchiveV3Builder) WithVersion(version string) *CordovaArchiveV3Builder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *CordovaArchiveV3Builder) WithInput(key, value string) *CordovaArchiveV3Builder {
