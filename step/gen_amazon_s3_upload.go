...
func (b *AmazonS3UploadBuilder) WithVersion(version string) *AmazonS3UploadBuilder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *AmazonS3UploadBuilder) WithInput(key, value string) *AmazonS3UploadBuilder {
