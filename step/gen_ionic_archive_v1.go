...
func (b *IonicArchiveV1Builder) WithVersion(version string) *IonicArchiveV1Builder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *IonicArchiveV1Builder) WithInput(key, value string) *IonicArchiveV1Builder {
