...
func (b *ExportXcarchiveV0Builder) WithVersion(version string) *ExportXcarchiveV0Builder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *ExportXcarchiveV0Builder) WithInput(key, value string) *ExportXcarchiveV0Builder {
