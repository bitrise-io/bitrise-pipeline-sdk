...
func (b *RemoteScriptRunnerBuilder) WithVersion(version string) *RemoteScriptRunnerBuilder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *RemoteScriptRunnerBuilder) WithInput(key, value string) *RemoteScriptRunnerBuilder {
