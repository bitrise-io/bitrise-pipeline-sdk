...
func (b *LambdatestXcuitestAppAutomateBuilder) WithVersion(version string) *LambdatestXcuitestAppAutomateBuilder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *LambdatestXcuitestAppAutomateBuilder) WithInput(key, value string) *LambdatestXcuitestAppAutomateBuilder {
