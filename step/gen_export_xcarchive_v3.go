...
func (b *ExportXcarchiveV3Builder) WithVersion(version string) *ExportXcarchiveV3Builder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *ExportXcarchiveV3Builder) WithInput(key, value string) *ExportXcarchiveV3Builder {
