...
func (b *GenericFileStorageBuilder) WithVersion(version string) *GenericFileStorageBuilder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *GenericFileStorageBuilder) WithInput(key, value string) *GenericFileStorageBuilder {
