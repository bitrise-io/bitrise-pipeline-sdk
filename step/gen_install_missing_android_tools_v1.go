...
func (b *InstallMissingAndroidToolsV1Builder) WithVersion(version string) *InstallMissingAndroidToolsV1Builder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *InstallMissingAndroidToolsV1Builder) WithInput(key, value string) *InstallMissingAndroidToolsV1Builder {
