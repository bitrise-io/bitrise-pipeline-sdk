...
func (b *RestoreCarthageCacheV3Builder) WithVersion(version string) *RestoreCarthageCacheV3Builder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *RestoreCarthageCacheV3Builder) WithInput(key, value string) *RestoreCarthageCacheV3Builder {
...
func (b *RestoreCarthageCacheV3Builder) WithTimeoutDuration(d time.Duration) *RestoreCarthageCacheV3Builder {
	b.Builder.WithTimeoutDuration(d)
	return b
}

// WithNoOutputTimeoutDuration sets the no-output timeout using a time.Duration.
func (b *RestoreCarthageCacheV3Builder) WithNoOutputTimeoutDuration(d time.Duration) *RestoreCarthageCacheV3Builder {
