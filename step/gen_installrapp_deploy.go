...
func (b *InstallrappDeployBuilder) WithVersion(version string) *InstallrappDeployBuilder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *InstallrappDeployBuilder) WithInput(key, value string) *InstallrappDeployBuilder {
...
func (b *InstallrappDeployBuilder) WithTimeoutDuration(d time.Duration) *InstallrappDeployBuilder {
	b.Builder.WithTimeoutDuration(d)
	return b
}

// WithNoOutputTimeoutDuration sets the no-output timeout using a time.Duration.
func (b *InstallrappDeployBuilder) WithNoOutputTimeoutDuration(d time.Duration) *InstallrappDeployBuilder {
