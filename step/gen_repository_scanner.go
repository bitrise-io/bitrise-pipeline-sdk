...
func (b *RepositoryScannerBuilder) WithVersion(version string) *RepositoryScannerBuilder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *RepositoryScannerBuilder) WithInput(key, value string) *RepositoryScannerBuilder {
