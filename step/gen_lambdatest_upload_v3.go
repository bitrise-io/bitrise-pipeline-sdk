...
func (b *LambdatestUploadV3Builder) WithVersion(version string) *LambdatestUploadV3Builder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *LambdatestUploadV3Builder) WithInput(key, value string) *LambdatestUploadV3Builder {
