...
func (b *BeatAndroidCodeStatsBuilder) WithVersion(version string) *BeatAndroidCodeStatsBuilder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *BeatAndroidCodeStatsBuilder) WithInput(key, value string) *BeatAndroidCodeStatsBuilder {
