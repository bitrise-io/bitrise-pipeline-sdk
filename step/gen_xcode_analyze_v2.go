...
func (b *XcodeAnalyzeV2Builder) WithVersion(version string) *XcodeAnalyzeV2Builder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *XcodeAnalyzeV2Builder) WithInput(key, value string) *XcodeAnalyzeV2Builder {
