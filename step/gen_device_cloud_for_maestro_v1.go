...
func (b *DeviceCloudForMaestroV1Builder) WithVersion(version string) *DeviceCloudForMaestroV1Builder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *DeviceCloudForMaestroV1Builder) WithInput(key, value string) *DeviceCloudForMaestroV1Builder {
