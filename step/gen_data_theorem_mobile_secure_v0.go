...
func (b *DataTheoremMobileSecureV0Builder) WithTimeoutDuration(d time.Duration) *DataTheoremMobileSecureV0Builder {
	b.Builder.WithTimeoutDuration(d)
	return b
}

// WithNoOutputTimeoutDuration sets the no-output timeout using a time.Duration.
func (b *DataTheoremMobileSecureV0Builder) WithNoOutputTimeoutDuration(d time.Duration) *DataTheoremMobileSecureV0Builder {
