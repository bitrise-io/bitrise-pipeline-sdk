...
func (b *RestoreNpmCacheV2Builder) WithVersion(version string) *RestoreNpmCacheV2Builder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *RestoreNpmCacheV2Builder) WithInput(key, value string) *RestoreNpmCacheV2Builder {
