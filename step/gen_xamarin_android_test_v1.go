...
func (b *XamarinAndroidTestV1Builder) WithVersion(version string) *XamarinAndroidTestV1Builder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *XamarinAndroidTestV1Builder) WithInput(key, value string) *XamarinAndroidTestV1Builder {
