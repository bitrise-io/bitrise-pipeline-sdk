...
func (b *GetPubspecVersionAndBuildNumberBuilder) WithVersion(version string) *GetPubspecVersionAndBuildNumberBuilder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *GetPubspecVersionAndBuildNumberBuilder) WithInput(key, value string) *GetPubspecVersionAndBuildNumberBuilder {
