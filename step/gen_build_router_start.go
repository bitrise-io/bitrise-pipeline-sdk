...
func (b *BuildRouterStartBuilder) WithVersion(version string) *BuildRouterStartBuilder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *BuildRouterStartBuilder) WithInput(key, value string) *BuildRouterStartBuilder {
