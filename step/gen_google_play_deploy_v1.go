...
func (b *GooglePlayDeployV1Builder) WithVersion(version string) *GooglePlayDeployV1Builder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *GooglePlayDeployV1Builder) WithInput(key, value string) *GooglePlayDeployV1Builder {
