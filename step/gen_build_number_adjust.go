...
func (b *BuildNumberAdjustBuilder) WithVersion(version string) *BuildNumberAdjustBuilder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *BuildNumberAdjustBuilder) WithInput(key, value string) *BuildNumberAdjustBuilder {
