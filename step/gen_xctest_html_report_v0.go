...
func (b *XctestHtmlReportV0Builder) WithVersion(version string) *XctestHtmlReportV0Builder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *XctestHtmlReportV0Builder) WithInput(key, value string) *XctestHtmlReportV0Builder {
