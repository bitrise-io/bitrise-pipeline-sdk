...
func (b *XcodeTestV6Builder) WithVersion(version string) *XcodeTestV6Builder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *XcodeTestV6Builder) WithInput(key, value string) *XcodeTestV6Builder {
...
func (b *XcodeTestV6Builder) WithTimeoutDuration(d time.Duration) *XcodeTestV6Builder {
	b.Builder.WithTimeoutDuration(d)
	return b
}

// WithNoOutputTimeoutDuration sets the no-output timeout using a time.Duration.
func (b *XcodeTestV6Builder) WithNoOutputTimeoutDuration(d time.Duration) *XcodeTestV6Builder {
