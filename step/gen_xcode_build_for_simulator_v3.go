...
func (b *XcodeBuildForSimulatorV3Builder) WithVersion(version string) *XcodeBuildForSimulatorV3Builder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *XcodeBuildForSimulatorV3Builder) WithInput(key, value string) *XcodeBuildForSimulatorV3Builder {
