...
func (b *ActivateBuildCacheForReactNativeBuilder) WithVersion(version string) *ActivateBuildCacheForReactNativeBuilder {
	b.Builder.WithVersion(version)
	return b
}

// WithInput sets a step input by raw key/value. Use this as an escape hatch for inputs not yet exposed as typed methods.
func (b *ActivateBuildCacheForReactNativeBuilder) WithInput(key, value string) *ActivateBuildCacheForReactNativeBuilder {
